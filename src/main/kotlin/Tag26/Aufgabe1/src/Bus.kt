...
// Hier erstellen wir eine Klasse mit dem Namen Tag26.Bus.
class Bus {
    var seats = 42

    // Bis jetzt ist unsere Klasse leer und kann noch nichts.
    // Als Erstes geben wir unsere Klasse eine Eigenschaft.
    // Unser Tag26.Bus soll 500 PS haben.
    // Eine Eigenschaft ist eine Variable/Konstante innerhalb einer Klasse.
    var horsePower = 500

    // Wir wollen, dass ein Tag26.Bus hupen kann, also erstellen wir eine Methode mit dem Namen "honk".
    ...
    // Wir wollen, dass ein Tag26.Bus eine Durchsage "Bitte aussteigen" machen kann.

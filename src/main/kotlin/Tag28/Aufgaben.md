...
**Datei für die Aufgabe:** Tag28.Airplane.kt
</details>
...
**1. Datei für die Aufgabe:** Tag28.Book.kt  
**2. Datei für die Aufgabe:** Tag28.Page.kt
</details>
...
In unserer Tag28.main()-Funktion steht folgendes:
...
<details>
<summary><b>Aufgabe 7 - Pinguine und Tag28.Adler </b></summary>

Wir wollen ein paar Vögel für ein Spiel abbilden.
Hier siehst du das Klassendiagramm für die drei Klassen:
- Basisklasse Tag28.Vogel (Bird)
- Unterklasse Tag28.Pinguin (Penguin)
- Unterklasse Tag28.Adler (Eagle)

Ein Tag28.Vogel hat die Eigenschaften:
- Gewicht (weight), dass das Gewicht des Vogels in Gramm angibt.
- ein Boolean (canFly), ob der Tag28.Vogel fliegen kann (true) oder nicht (false).

Außerdem hat der Tag28.Vogel einen Konstruktor und die Methode makeNoise(), 
dass in der Konsole "Animal noises." ausgibt.

Die Tag28.Pinguin-Klasse erbt von der Tag28.Vogel-Klasse.
Für den Parameter canFly übergibt die Tag28.Pinguin-Klasse ein false (Auch wenn 
...
Die Tag28.Pinguin-Klasse hat einen Konstruktor mit einem Parameter weight.

Die Tag28.Adler-Klasse erbt von der Tag28.Vogel-Klasse. Für den Parameter canFly übergibt die Tag28.Adler-Klasse ein true.
Daher hat die Tag28.Adler-Klasse die Methode fly(), das "Fly free like an eagle!" in der Konsole ausgibt.
Die Tag28.Adler-Klasse hat einen Konstruktor mit einem Parameter weight.
...
- Instanziiere dann in einer Tag28.main()-Funktion einen Tag28.Adler und einen Tag28.Pinguin, jeweils mit einem
beliebigen Gewicht.
- Gib für beide Vögel in der Konsole aus, ob sie fliegen können.
- Lass beide Vögel Geräusche machen.
- Lass den Tag28.Pinguin watscheln und den Tag28.Adler fliegen.

Bonus:

- Füge einen weiteren Tag28.Vogel als Unterklasse hinzu.
